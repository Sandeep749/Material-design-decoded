package com.example.materialdesignfromgithub.activity;
...
import com.example.materialdesignfromgithub.BuildConfig;
import com.example.materialdesignfromgithub.R;
import com.example.materialdesignfromgithub.activity.about.AboutApp;
import com.example.materialdesignfromgithub.activity.about.AboutAppSimple;
import com.example.materialdesignfromgithub.activity.about.AboutAppSimpleBlue;
import com.example.materialdesignfromgithub.activity.about.AboutCompany;
import com.example.materialdesignfromgithub.activity.about.AboutCompanyCard;
import com.example.materialdesignfromgithub.activity.about.AboutCompanyImage;
import com.example.materialdesignfromgithub.activity.about.AboutDialogMainAction;
import com.example.materialdesignfromgithub.activity.article.ArticleBigHeader;
import com.example.materialdesignfromgithub.activity.article.ArticleCard;
import com.example.materialdesignfromgithub.activity.article.ArticleFood;
import com.example.materialdesignfromgithub.activity.article.ArticleFoodReview;
import com.example.materialdesignfromgithub.activity.article.ArticleMedium;
import com.example.materialdesignfromgithub.activity.article.ArticleMediumDark;
import com.example.materialdesignfromgithub.activity.article.ArticleSimple;
import com.example.materialdesignfromgithub.activity.article.ArticleStepper;
import com.example.materialdesignfromgithub.activity.bottomnavigation.BottomNavigationBasic;
import com.example.materialdesignfromgithub.activity.bottomnavigation.BottomNavigationDark;
import com.example.materialdesignfromgithub.activity.bottomnavigation.BottomNavigationIcon;
import com.example.materialdesignfromgithub.activity.bottomnavigation.BottomNavigationLight;
import com.example.materialdesignfromgithub.activity.bottomnavigation.BottomNavigationMapBlue;
import com.example.materialdesignfromgithub.activity.bottomnavigation.BottomNavigationPrimary;
import com.example.materialdesignfromgithub.activity.bottomnavigation.BottomNavigationShifting;
import com.example.materialdesignfromgithub.activity.bottomsheet.BottomSheetBasic;
import com.example.materialdesignfromgithub.activity.bottomsheet.BottomSheetFloating;
import com.example.materialdesignfromgithub.activity.bottomsheet.BottomSheetFull;
import com.example.materialdesignfromgithub.activity.bottomsheet.BottomSheetList;
import com.example.materialdesignfromgithub.activity.bottomsheet.BottomSheetMap;
import com.example.materialdesignfromgithub.activity.button.ButtonBasic;
import com.example.materialdesignfromgithub.activity.button.ButtonInUtilities;
import com.example.materialdesignfromgithub.activity.button.FabMiddle;
import com.example.materialdesignfromgithub.activity.button.FabMore;
import com.example.materialdesignfromgithub.activity.button.FabMoreText;
import com.example.materialdesignfromgithub.activity.card.CardBasic;
import com.example.materialdesignfromgithub.activity.card.CardOverlap;
import com.example.materialdesignfromgithub.activity.card.CardTimeline;
import com.example.materialdesignfromgithub.activity.card.CardWizard;
import com.example.materialdesignfromgithub.activity.card.CardWizardLight;
import com.example.materialdesignfromgithub.activity.card.CardWizardOverlap;
import com.example.materialdesignfromgithub.activity.chip.ChipBasic;
import com.example.materialdesignfromgithub.activity.chip.ChipTag;
import com.example.materialdesignfromgithub.activity.dashboard.DashboardCryptocurrency;
import com.example.materialdesignfromgithub.activity.dashboard.DashboardFinance;
import com.example.materialdesignfromgithub.activity.dashboard.DashboardFlight;
import com.example.materialdesignfromgithub.activity.dashboard.DashboardGridFab;
import com.example.materialdesignfromgithub.activity.dashboard.DashboardPayBill;
import com.example.materialdesignfromgithub.activity.dashboard.DashboardStatistics;
import com.example.materialdesignfromgithub.activity.dashboard.DashboardWallet;
import com.example.materialdesignfromgithub.activity.dashboard.DashboardWalletGreen;
import com.example.materialdesignfromgithub.activity.dialog.DialogAddPost;
import com.example.materialdesignfromgithub.activity.dialog.DialogAddReview;
import com.example.materialdesignfromgithub.activity.dialog.DialogBasic;
import com.example.materialdesignfromgithub.activity.dialog.DialogCustom;
import com.example.materialdesignfromgithub.activity.dialog.DialogCustomDark;
import com.example.materialdesignfromgithub.activity.dialog.DialogCustomInfo;
import com.example.materialdesignfromgithub.activity.dialog.DialogCustomLight;
import com.example.materialdesignfromgithub.activity.dialog.DialogCustomWarning;
import com.example.materialdesignfromgithub.activity.dialog.DialogFullscreen;
import com.example.materialdesignfromgithub.activity.dialog.DialogGDPRBasic;
import com.example.materialdesignfromgithub.activity.dialog.DialogHeader;
import com.example.materialdesignfromgithub.activity.dialog.DialogImage;
import com.example.materialdesignfromgithub.activity.dialog.DialogTermOfServices;
import com.example.materialdesignfromgithub.activity.expansionpanel.ExpansionPanelBasic;
import com.example.materialdesignfromgithub.activity.expansionpanel.ExpansionPanelInvoice;
import com.example.materialdesignfromgithub.activity.expansionpanel.ExpansionPanelTicket;
import com.example.materialdesignfromgithub.activity.form.FormLogin;
import com.example.materialdesignfromgithub.activity.form.FormProfileData;
import com.example.materialdesignfromgithub.activity.form.FormSignUp;
import com.example.materialdesignfromgithub.activity.form.FormTextArea;
import com.example.materialdesignfromgithub.activity.form.FormWithIcon;
import com.example.materialdesignfromgithub.activity.gridlist.GridAlbums;
import com.example.materialdesignfromgithub.activity.gridlist.GridBasic;
import com.example.materialdesignfromgithub.activity.gridlist.GridCaller;
import com.example.materialdesignfromgithub.activity.gridlist.GridSectioned;
import com.example.materialdesignfromgithub.activity.gridlist.GridSingleLine;
import com.example.materialdesignfromgithub.activity.gridlist.GridTwoLine;
import com.example.materialdesignfromgithub.activity.list.ListAnimation;
import com.example.materialdesignfromgithub.activity.list.ListBasic;
import com.example.materialdesignfromgithub.activity.list.ListDrag;
import com.example.materialdesignfromgithub.activity.list.ListExpand;
import com.example.materialdesignfromgithub.activity.list.ListMultiSelection;
import com.example.materialdesignfromgithub.activity.list.ListSectioned;
import com.example.materialdesignfromgithub.activity.list.ListSwipe;
import com.example.materialdesignfromgithub.activity.login.LoginCardLight;
import com.example.materialdesignfromgithub.activity.login.LoginCardOverlap;
import com.example.materialdesignfromgithub.activity.login.LoginImageTeal;
import com.example.materialdesignfromgithub.activity.login.LoginSimpleDark;
import com.example.materialdesignfromgithub.activity.login.LoginSimpleGreen;
import com.example.materialdesignfromgithub.activity.login.LoginSimpleLight;
import com.example.materialdesignfromgithub.activity.menu.MenuDrawerMail;
import com.example.materialdesignfromgithub.activity.menu.MenuDrawerNews;
import com.example.materialdesignfromgithub.activity.menu.MenuDrawerNoIcon;
import com.example.materialdesignfromgithub.activity.menu.MenuDrawerSimpleDark;
import com.example.materialdesignfromgithub.activity.menu.MenuDrawerSimpleLight;
import com.example.materialdesignfromgithub.activity.menu.MenuOverflowList;
import com.example.materialdesignfromgithub.activity.menu.MenuOverflowToolbar;
import com.example.materialdesignfromgithub.activity.noitem.NoItemArchived;
import com.example.materialdesignfromgithub.activity.noitem.NoItemBgCactus;
import com.example.materialdesignfromgithub.activity.noitem.NoItemBgCity;
import com.example.materialdesignfromgithub.activity.noitem.NoItemInternetIcon;
import com.example.materialdesignfromgithub.activity.noitem.NoItemInternetImage;
import com.example.materialdesignfromgithub.activity.noitem.NoItemSearch;
import com.example.materialdesignfromgithub.activity.noitem.NoItemTabs;
import com.example.materialdesignfromgithub.activity.payment.PaymentCardCollections;
import com.example.materialdesignfromgithub.activity.payment.PaymentCardDetails;
import com.example.materialdesignfromgithub.activity.payment.PaymentForm;
import com.example.materialdesignfromgithub.activity.payment.PaymentProfile;
import com.example.materialdesignfromgithub.activity.payment.PaymentSuccessDialog;
import com.example.materialdesignfromgithub.activity.picker.PickerColor;
import com.example.materialdesignfromgithub.activity.picker.PickerDateDark;
import com.example.materialdesignfromgithub.activity.picker.PickerDateLight;
import com.example.materialdesignfromgithub.activity.picker.PickerLocation;
import com.example.materialdesignfromgithub.activity.picker.PickerTimeDark;
import com.example.materialdesignfromgithub.activity.picker.PickerTimeLight;
import com.example.materialdesignfromgithub.activity.player.PlayerMusicAlbumCircle;
import com.example.materialdesignfromgithub.activity.player.PlayerMusicAlbumDark;
import com.example.materialdesignfromgithub.activity.player.PlayerMusicAlbumGrid;
import com.example.materialdesignfromgithub.activity.player.PlayerMusicAlbumSimple;
import com.example.materialdesignfromgithub.activity.player.PlayerMusicBasic;
import com.example.materialdesignfromgithub.activity.player.PlayerMusicGenre;
import com.example.materialdesignfromgithub.activity.player.PlayerMusicGenreImage;
import com.example.materialdesignfromgithub.activity.player.PlayerMusicGenreLight;
import com.example.materialdesignfromgithub.activity.player.PlayerMusicLight;
import com.example.materialdesignfromgithub.activity.player.PlayerMusicSongList;
import com.example.materialdesignfromgithub.activity.player.PlayerMusicTabs;
import com.example.materialdesignfromgithub.activity.player.PlayerMusicTabsIcon;
import com.example.materialdesignfromgithub.activity.player.PlayerVideoBasic;
import com.example.materialdesignfromgithub.activity.player.PlayerVideoSimple;
import com.example.materialdesignfromgithub.activity.profile.ProfileBlueAppbar;
import com.example.materialdesignfromgithub.activity.profile.ProfileCardList;
import com.example.materialdesignfromgithub.activity.profile.ProfileDrawerImage;
import com.example.materialdesignfromgithub.activity.profile.ProfileDrawerSimple;
import com.example.materialdesignfromgithub.activity.profile.ProfileFabMenu;
import com.example.materialdesignfromgithub.activity.profile.ProfileGallery;
import com.example.materialdesignfromgithub.activity.profile.ProfileGalleryTwo;
import com.example.materialdesignfromgithub.activity.profile.ProfileImageAppbar;
import com.example.materialdesignfromgithub.activity.profile.ProfilePolygon;
import com.example.materialdesignfromgithub.activity.profile.ProfilePurple;
import com.example.materialdesignfromgithub.activity.profile.ProfileRed;
import com.example.materialdesignfromgithub.activity.progressactivity.ProgressBasic;
import com.example.materialdesignfromgithub.activity.progressactivity.ProgressCircleCenter;
import com.example.materialdesignfromgithub.activity.progressactivity.ProgressDotsBounce;
import com.example.materialdesignfromgithub.activity.progressactivity.ProgressDotsFade;
import com.example.materialdesignfromgithub.activity.progressactivity.ProgressDotsGrow;
import com.example.materialdesignfromgithub.activity.progressactivity.ProgressLinearCenter;
import com.example.materialdesignfromgithub.activity.progressactivity.ProgressLinearTop;
import com.example.materialdesignfromgithub.activity.progressactivity.ProgressOnScroll;
import com.example.materialdesignfromgithub.activity.progressactivity.ProgressPullRefresh;
import com.example.materialdesignfromgithub.activity.search.SearchCity;
import com.example.materialdesignfromgithub.activity.search.SearchFilterHotel;
import com.example.materialdesignfromgithub.activity.search.SearchFilterProduct;
import com.example.materialdesignfromgithub.activity.search.SearchFilterProperty;
import com.example.materialdesignfromgithub.activity.search.SearchHistoryCard;
import com.example.materialdesignfromgithub.activity.search.SearchPrimary;
import com.example.materialdesignfromgithub.activity.search.SearchPrimaryBg;
import com.example.materialdesignfromgithub.activity.search.SearchStore;
import com.example.materialdesignfromgithub.activity.search.SearchToolbarDark;
import com.example.materialdesignfromgithub.activity.search.SearchToolbarLight;
import com.example.materialdesignfromgithub.activity.settings.SettingFlat;
import com.example.materialdesignfromgithub.activity.settings.SettingProfile;
import com.example.materialdesignfromgithub.activity.settings.SettingProfileLight;
import com.example.materialdesignfromgithub.activity.settings.SettingSectioned;
import com.example.materialdesignfromgithub.activity.shopping.ShoppingCartCard;
import com.example.materialdesignfromgithub.activity.shopping.ShoppingCartCardDark;
import com.example.materialdesignfromgithub.activity.shopping.ShoppingCartSimple;
import com.example.materialdesignfromgithub.activity.shopping.ShoppingCategoryCard;
import com.example.materialdesignfromgithub.activity.shopping.ShoppingCategoryImage;
import com.example.materialdesignfromgithub.activity.shopping.ShoppingCategoryList;
import com.example.materialdesignfromgithub.activity.shopping.ShoppingCheckoutCard;
import com.example.materialdesignfromgithub.activity.shopping.ShoppingCheckoutOnePage;
import com.example.materialdesignfromgithub.activity.shopping.ShoppingCheckoutStep;
import com.example.materialdesignfromgithub.activity.shopping.ShoppingCheckoutTimeline;
import com.example.materialdesignfromgithub.activity.shopping.ShoppingProductAdvDetails;
import com.example.materialdesignfromgithub.activity.shopping.ShoppingProductDetails;
import com.example.materialdesignfromgithub.activity.shopping.ShoppingProductGrid;
import com.example.materialdesignfromgithub.activity.shopping.ShoppingSubCategoryTabs;
import com.example.materialdesignfromgithub.activity.slider.SliderColorPicker;
import com.example.materialdesignfromgithub.activity.slider.SliderDark;
import com.example.materialdesignfromgithub.activity.slider.SliderLight;
import com.example.materialdesignfromgithub.activity.sliderimage.SliderImageCard;
import com.example.materialdesignfromgithub.activity.sliderimage.SliderImageCardAuto;
import com.example.materialdesignfromgithub.activity.sliderimage.SliderImageHeader;
import com.example.materialdesignfromgithub.activity.sliderimage.SliderImageHeaderAuto;
import com.example.materialdesignfromgithub.activity.snackbartoast.SnackbarAndFab;
import com.example.materialdesignfromgithub.activity.snackbartoast.SnackbarToastBasic;
import com.example.materialdesignfromgithub.activity.stepper.StepperDots;
import com.example.materialdesignfromgithub.activity.stepper.StepperProgress;
import com.example.materialdesignfromgithub.activity.stepper.StepperText;
import com.example.materialdesignfromgithub.activity.stepper.StepperVertical;
import com.example.materialdesignfromgithub.activity.stepper.StepperWizardColor;
import com.example.materialdesignfromgithub.activity.stepper.StepperWizardLight;
import com.example.materialdesignfromgithub.activity.tabs.TabsBasic;
import com.example.materialdesignfromgithub.activity.tabs.TabsDark;
import com.example.materialdesignfromgithub.activity.tabs.TabsIcon;
import com.example.materialdesignfromgithub.activity.tabs.TabsIconLight;
import com.example.materialdesignfromgithub.activity.tabs.TabsIconStack;
import com.example.materialdesignfromgithub.activity.tabs.TabsLight;
import com.example.materialdesignfromgithub.activity.tabs.TabsRound;
import com.example.materialdesignfromgithub.activity.tabs.TabsScroll;
import com.example.materialdesignfromgithub.activity.tabs.TabsStore;
import com.example.materialdesignfromgithub.activity.tabs.TabsTextIcon;
import com.example.materialdesignfromgithub.activity.timeline.TimelineDotCard;
import com.example.materialdesignfromgithub.activity.timeline.TimelineFeed;
import com.example.materialdesignfromgithub.activity.timeline.TimelinePath;
import com.example.materialdesignfromgithub.activity.timeline.TimelineSimple;
import com.example.materialdesignfromgithub.activity.timeline.TimelineTwitter;
import com.example.materialdesignfromgithub.activity.toolbar.ToolbarBasic;
import com.example.materialdesignfromgithub.activity.toolbar.ToolbarCollapse;
import com.example.materialdesignfromgithub.activity.toolbar.ToolbarCollapsePin;
import com.example.materialdesignfromgithub.activity.toolbar.ToolbarDark;
import com.example.materialdesignfromgithub.activity.toolbar.ToolbarLight;
import com.example.materialdesignfromgithub.activity.verification.VerificationBlue;
import com.example.materialdesignfromgithub.activity.verification.VerificationCode;
import com.example.materialdesignfromgithub.activity.verification.VerificationHeader;
import com.example.materialdesignfromgithub.activity.verification.VerificationImage;
import com.example.materialdesignfromgithub.activity.verification.VerificationOrange;
import com.example.materialdesignfromgithub.activity.verification.VerificationPhone;
import com.example.materialdesignfromgithub.adapter.ExpandableRecyclerAdapter;
import com.example.materialdesignfromgithub.adapter.MainMenuAdapter;
import com.example.materialdesignfromgithub.data.SharedPref;
import com.example.materialdesignfromgithub.model.MenuType;
    ...
    private void showDialogAbout() {
        ...
        ((View) dialog.findViewById(R.id.bt_getcode)).setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                i.setData(Uri.parse("https://decodersandeep.blogspot.com/"));
                startActivity(i);
            }
        });
