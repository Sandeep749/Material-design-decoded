package com.example.materialdesignfromgithub.activity.list;
...
import com.example.materialdesignfromgithub.adapter.AdapterListInbox;
...
import com.example.materialdesignfromgithub.widget.LineItemDecoration;
...
public class ListMultiSelection extends AppCompatActivity {
    ...
    private class ActionModeCallback implements ActionMode.Callback, androidx.appcompat.view.ActionMode.Callback {
        @Override
